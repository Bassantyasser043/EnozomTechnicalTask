...
namespace Repositories.Migrations
{
    ...
    [Migration("20241014151026_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repositories.Entities.Day", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Entities.Doctor", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Entities.DoctorAvailability", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Entities.TimeRange", b =>
                {
                    b.Property<int>("TimeRangeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Repositories.Entities.DoctorAvailability", b =>
                {
                    b.HasOne("Repositories.Entities.Day", "Day")
                        .WithMany("DoctorAvailabilities")
                        .HasForeignKey("DayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Repositories.Entities.Doctor", "Doctor")
                        .WithMany("DoctorAvailabilities")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Repositories.Entities.TimeRange", "TimeRanges")
                        .WithMany("DoctorAvailabilities")
